...
object LiniesDrawers {
    ...
    private fun createDateDrawer(context: Context) = DateWatchDrawer(PreferenceHelper.getColor(context, Type.DATE), 2f, PreferenceHelper.isVisible(context, Type.DIGITAL), 8f, -1.85f, "dd-MM-YYYY")
}
